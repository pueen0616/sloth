         ...
         <tbody>
            <c:forEach items="${reserInfo2}" var="reserInfo2" varStatus="i">
               <tr>
                  ...
                  <td><input type="date" value="${reserInfo2.reserCheckIn}" id="reser_upd_checkIn" name="reser_upd_checkIn"></td>
                  <td><input type="date" value="${reserInfo2.reserCheckOut}" id="reser_upd_checkOut" name="reser_upd_checkOut"></td>
                  ...
                  <input type="hidden" name="aa" value="${reserInfo2.reserNum}">
