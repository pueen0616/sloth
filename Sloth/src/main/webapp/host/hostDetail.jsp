	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<!-- Author -->
				<p class="lead">
					<span class="_10pmr93"><span class="_1fwtdr4"><span
							class="_8tbpu3" aria-hidden="true">󰀄</span></span><span class="_nu65sd"><button
								aria-label="후기 38개로부터 5점 만점에 4.32점을 받은 숙소입니다." tabindex="-1"
								type="button" class="_z75ovys">
								<span class="_1jpdmc0">4.32</span><span class="_1sqnphj">(38)</span>
							</button></span></span> <a href="#">주소 주소 주소 주소 주소</a>
				</p>
				<hr>
				<!-- Date/Time -->
				...
				<!-- Preview Image -->
				<div>
					<div class="imgCollage1">
						<img class="img-fluid rounded1" src="images/room1.jpeg" alt="">
					</div>
					<div class="imgCollage">
						<span style="width: 48.8%"> <img class="img-fluid rounded4"
							src="images/room1.jpeg" alt="">
						</span> <span style="width: 48.8%"> <img
							class="img-fluid rounded4" src="images/room1.jpeg" alt="">
						</span>
					</div>
					<div class="imgCollage">
						<span style="width: 48.8%"> <img class="img-fluid rounded4"
				...
				<!-- Comments Form -->
				<div class="card my-4">
					<h5 class="card-header">평점 및 후기</h5>
					<div class="card-body">
						<form>
