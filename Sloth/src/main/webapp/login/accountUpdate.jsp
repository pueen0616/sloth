...
<body>
   ...
   <div class="container" align="center">
      <h1>회원 정보 수정</h1>
      <hr/>
      <form id="updateFrm" name="updateFrm" action="AccountUpdate.do"  method="post">
         ...
         <div class="_s1t1w0" style="margin-bottom: 16px;">비밀번호 확인</div>
         <div style="margin-bottom: 32px;">
            <input type="password" id="pwreview" name="pwreview" >
         </div>
         ...
         <div class="_s1t1w0" style="margin-bottom: 16px;">userType</div>
         <div style="margin-bottom: 32px;"><input type="text" id="userType" name="userType" value="${user.userType}"></div>
   

         <div>
            <input class="btn btn-primary" type="submit" value="수정하기"> &nbsp;&nbsp; 
            <button class="btn btn-primary" type="reset" value="취소" onclick="history.back();">취소</button>
         </div>
      </form>
   </div>
   <script>
